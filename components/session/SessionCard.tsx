        ...
        {isAdmin ? (
          <div className="flex w-full items-center justify-end gap-2">
            <button
              ...
              className="self-end text-sm px-3 py-1 md:px-5 md:py-2 bg-myorange hover:bg-myorange/80 text-white font-semibold rounded-md transition duration-300"
            >
              Insribirte
            </button>
            <button
              ...
              className="self-end text-sm px-3 py-1 md:px-5 md:py-2 bg-slate-400 hover:bg-slate-500 text-white font-semibold rounded-md transition duration-300"
            >
              Modificar
            </button>
          </div>
          ...
          <button
            onClick={() => handleOpenModal(sessionId)}
            className="self-end text-sm px-3 py-1 md:px-5 md:py-2 bg-myorange text-white font-semibold rounded-md"
          >
            Saber más
          </button>
        )}
